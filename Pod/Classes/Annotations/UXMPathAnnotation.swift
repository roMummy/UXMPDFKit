...
open class UXMPathAnnotation: NSObject, NSCoding {
...
class PDFPathView: ResizableView, UXMPDFAnnotationView {
    var parent: UXMAnnotation?
    override var canBecomeFirstResponder: Bool { return true }
    
    convenience init(parent: UXMPathAnnotation, frame: CGRect) {
    ...
    override func draw(_ rect: CGRect) {
        (parent as? UXMPathAnnotation)?.drawRect(rect)
    }
}

extension UXMPathAnnotation: UXMAnnotation {
...
open class UXMPenAnnotation: UXMPathAnnotation, UXMPDFAnnotationButtonable {
    
    public static var name: String? { return "Pen" }
    public static var buttonImage: UIImage? { return UIImage.bundledImage("pen") }
}

open class UXMHighlighterAnnotation: UXMPathAnnotation, UXMPDFAnnotationButtonable {
